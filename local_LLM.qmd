...
ellmer以外で、ローカルLLMを使えるパッケージ

-   [mall](https://cran.r-project.org/package=mall): 文書の要約・分類・翻訳など

-   [ragnar](https://cloud.r-project.org/package=ragnar): RAG (Retrieval-Augmented Generation)
