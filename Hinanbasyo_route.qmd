...
-   Rでもできる
    ...
    -   Kanazawa.R #3での[NONONOexeさんの発表](https://www.docswell.com/s/NONONOexe/Z823Q1-kanazawar-3)
...
-   CRANから入手可能（[CRAN Package](https://cran.r-project.org/package=osrm)[:](https://cran.r-project.org/package=osrm)[osrm](https://cran.r-project.org/package=osrm)）
